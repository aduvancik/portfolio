          ...
          <div className="absolute right-0 top-0 h-full w-[80%] z-[2]">
            ...
            <div className="flex flex-col gap-3 z-[10] pl-40 pt-20">
                ...
                <p className="text-[16px] text-gray-200 md:text-gray-400 md:pb-2 mb-10 max-w-[400px]">
                    ...
                    Ipsam recusandae, eaque architecto nisi dolor voluptatibus
                    voluptatem ea magnam iste fugit magni, error, animi pariatur
                    nobis neque rem explicabo debitis? Minus?
                </p>
