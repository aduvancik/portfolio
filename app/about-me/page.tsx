...
const page = () => {
    return (
        <div className="flex items-center justify-center bg-[#0C011A] h-screen overflow-hidden">
            ...
            <div className="absolute -left-36 bottom-5 rotate-12 animate-pulse duraton-75">
                <Image
                    src={"/assets/bulb.png"}
                    alt="bulb"
                    width={260}
